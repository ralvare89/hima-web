                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {['electrical','hvac','automation','mechanical','maintenance','management','other'].map((s) => (
                          <option key={s} value={s}>{t(`contact.form_service_${s}`)}</option>
                        ))}
                      </select>
                    </div>
                  </div>
                ...
                <StaggerItem key={key}>
                  <div className="bg-hima-card border border-white/5 rounded-lg p-5 flex items-start gap-4 hover:border-hima-green/25 transition-colors duration-300">
                    ...
                    <div>
                      ...
                      <div className="text-hima-white font-medium text-sm">{t(`contact.${valKey}`)}</div>
                    </div>
                  </div>
                </StaggerItem>
              ))}
